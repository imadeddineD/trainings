  ...
  return (
    <section className='container-px py-5'>
      <div className='text-center xl:mb-[60px] lg:mb-[55px] mb-[60px]'>
        <h2 className='font-bold text-[28px] text-[#DA0E29] xl:mb-[14px] lg:mb-1 mb-[14px]'>
          Our Blogs
        </h2>
        <h3 className={`${inter.className} text-[#2C3C58] xl:text-[45px] lg:text-[42px] md:text-[45px] sm:text-[39px] text-[32px]`}>
