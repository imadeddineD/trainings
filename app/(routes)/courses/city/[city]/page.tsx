...
// Course-specific location change
...
// Initialize search and location on first mount
useEffect(() => {
...
// Update courseSelections when courses change
useEffect(() => {
  if (courses.length > 0) {
...
// Add custom styles for responsive datepicker courses-btn
