...
const SectionsNav: React.FC<ClientsCarouselProps> = ({ currentSection, user, progress, sections }) => {
  ...
  const isResultsPage = ["/results", "/managerResults", "/finalResults", "/tips"].includes(currentPath);
        ...
        <ul className="flex gap-7 max-[826px]:gap-2">
          <li>
            <button
              ...
              className="inline-block p-3 pt-1 max-sm:p-2 max-sm:pt-1 bg-transparent border-none cursor-pointer"
            >
              تسجيل الخروج
            </button>
          </li>
